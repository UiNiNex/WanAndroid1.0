...
public class FlowLayout extends ViewGroup{
    ...
    ArrayList<List<View>> mViewLinesList = new ArrayList();
    ...
    ArrayList<Integer> mLineHeights = new ArrayList<>();
    ...
    protected void onLayout(boolean b, int i, int i1, int i2, int i3) {
        for (int a = 0; a<mViewLinesList.size(); a++){
            List<View> viewList = mViewLinesList.get(a);
